...
namespace jcu {
    namespace random {
        ...
        static void R0(const uint32_t block[DIGEST_BLOCK_INTS], const uint32_t v, uint32_t &w, const uint32_t x, const uint32_t y, uint32_t &z, const unsigned int i)
        {
            z += ((w&(x^y))^y) + block[i] + 0x5a827999 + rol(v, 5);
            w = rol(w, 30);
        }

        static void R1(uint32_t block[DIGEST_BLOCK_INTS], const uint32_t v, uint32_t &w, const uint32_t x, const uint32_t y, uint32_t &z, const unsigned int i)
        {
            block[i] = blk(block, i);
            z += ((w&(x^y))^y) + block[i] + 0x5a827999 + rol(v, 5);
            w = rol(w, 30);
        ...
        static void R2(uint32_t block[DIGEST_BLOCK_INTS], const uint32_t v, uint32_t &w, const uint32_t x, const uint32_t y, uint32_t &z, const unsigned int i)
        {
            block[i] = blk(block, i);
        ...
        static void R3(uint32_t block[DIGEST_BLOCK_INTS], const uint32_t v, uint32_t &w, const uint32_t x, const uint32_t y, uint32_t &z, const unsigned int i)
        {
            block[i] = blk(block, i);
        ...
        static void R4(uint32_t block[DIGEST_BLOCK_INTS], const uint32_t v, uint32_t &w, const uint32_t x, const uint32_t y, uint32_t &z, const unsigned int i)
        {
            block[i] = blk(block, i);
